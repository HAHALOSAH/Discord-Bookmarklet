//This code was taken from https://github.com/rauenzi/BDPluginLibrary/blob/master/src/modules/webpackmodules.js
//Starting here:
class Filters {
    /**
...
//End of taken code
var cmd = prompt("HHLS-DISCORD-MOD: Enter Command...");
var args = cmd.split(" ");
var cmdname = args.shift();
switch(cmdname) {
  case "devmode":
    Object.defineProperty(WebpackModules.findByProps(["isDeveloper"]),"isDeveloper",{get:_=>1,set:_=>_,configurable:true});
    break;
  default:
